...
contract SpecialRaceRouter is ReentrancyGuard,Ownable,ITokenRacesRouter {
    ...
    uint public minAndMaxParticipationFeeAmount = 0.05 ether; 
    uint256 public platformFee = 10;
    uint32 public totalParticipants = 30;
    string private name="Special Race";
    ...
    uint256 public maxLengthRace = 2 hours;
    IERC20 public weth;
    ...
    function openTrade() external onlyOwner() {
        ...
        require(raceLastPlayerIndex[currentRaceId] == totalParticipants,"Not all players joined in race");
