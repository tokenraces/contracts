...
contract StarterRaceBasement is Ownable,IERC20,IERC20Metadata {
...
contract StarterRaceFactory is Ownable,ITokenRacesFactory {    
    ...
    function startRacingToken(
        ...
        StarterRaceBasement race = new StarterRaceBasement();
