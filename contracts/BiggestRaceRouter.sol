...
contract BiggestRaceRouter is ReentrancyGuard,Ownable,ITokenRacesRouter {
    ...
    uint public minAndMaxParticipationFeeAmount = 2 ether; 
    uint256 public platformFee = 10;
    uint32 public totalParticipants = 20;
    string private name="Biggest Race";
    string private symbol="BRC";
    ...
    uint256 public maxLengthRace = 24 hours;
    IERC20 public weth;
