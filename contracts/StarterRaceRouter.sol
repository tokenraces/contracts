...
contract StarterRaceRouter is ReentrancyGuard,Ownable,ITokenRacesRouter {
    ...
    uint public minAndMaxParticipationFeeAmount = 0.1 ether; 
    uint256 public platformFee = 10;
    uint32 public totalParticipants = 10;
    string private name="Starter Race";
