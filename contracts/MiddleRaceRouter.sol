...
contract MiddleRaceRouter is ReentrancyGuard,Ownable,ITokenRacesRouter {
    ...
    uint public minAndMaxParticipationFeeAmount = 1 ether; 
    uint256 public platformFee = 10;
    uint32 public totalParticipants = 10;
    string private name="Middle Race";
    string private symbol="MRC";
    ...
    uint256 public maxLengthRace = 12 hours;
    IERC20 public weth;
