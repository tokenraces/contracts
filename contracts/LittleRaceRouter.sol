...
contract LittleRaceRouter is ReentrancyGuard,Ownable,ITokenRacesRouter {
    ...
    string private name="Little Race";
    string private symbol="LRC";
    ...
    uint256 public maxLengthRace = 6 hours;
    IERC20 public weth;
