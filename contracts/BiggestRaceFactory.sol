...
contract BiggestRaceBasement is Ownable,IERC20,IERC20Metadata {
...
contract BiggestRaceFactory is Ownable,ITokenRacesFactory {    
    ...
    function startRacingToken(
        ...
        BiggestRaceBasement race = new BiggestRaceBasement();
