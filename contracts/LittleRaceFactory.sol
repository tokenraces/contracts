...
contract LittleRaceBasement is Ownable,IERC20,IERC20Metadata {
...
contract LittleRaceFactory is Ownable,ITokenRacesFactory {    
    ...
    function startRacingToken(
        ...
        LittleRaceBasement race = new LittleRaceBasement();
