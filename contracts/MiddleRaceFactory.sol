...
contract MiddleRaceBasement is Ownable,IERC20,IERC20Metadata {
...
contract MiddleRaceFactory is Ownable,ITokenRacesFactory {    
    ...
    function startRacingToken(
        ...
        MiddleRaceBasement race = new MiddleRaceBasement();
